...
const HomePage = () => {
  ...
  return (
    <div className="grid grid-cols-1 place-content-center bg-yellow-200 min-h-screen h-full w-full ">
      ...
      <input className="m-2 p-2 bg-blue-200 rounded-lg"  placeholder="Display Name" onChange={handleInput} onKeyUp={checkKey}></input>
      <button className="bg-blue-500 px-5 py-2 border-2 border-blue-700 rounded-lg text-white font-semibold" ref={butref} onClick={joinRoom}>Join Room</button>
      
        <div hidden={!displayNameInvalid}><span className="text-sm text-red-500">
